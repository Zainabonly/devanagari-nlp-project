...
# ========== TOKENIZER ==========
print("[INFO] Loading tokenizer:", BPE_TOKENIZER_PATH)
...
class Seq2SeqTransformer(nn.Module):
    ...
    def forward(self, src, tgt):
        ...
        out = self.tf(
            ...
            memory_key_padding_mask=src_pad   # <-- REQUIRED
        )
...
orig_out_path = os.path.join(OUTPUT_DIR, "test_original_inputs_normal_bpe.txt")
...
tok_out_path = os.path.join(OUTPUT_DIR, "test_tokenized_inputs_normal_bpe.txt")
...
seq_out_path = os.path.join(OUTPUT_DIR, "test_seq2seq_outputs_normal_bpe.txt")
